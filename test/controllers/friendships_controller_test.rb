...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { category: @friendship.category, contact_id: @friendship.contact_id, user_id: @friendship.user_id }
    end
  ...
  test "should update friendship" do
    patch :update, id: @friendship, friendship: { category: @friendship.category, contact_id: @friendship.contact_id, user_id: @friendship.user_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
